...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "repositories",
          description: "Explore my GitHub contributions, projects, and stats—showcasing my work",
          section: "Navigation",
          handler: () => {
      ...
      handler: () => {
          ...
          window.location.href = "/blog/2025/app-store-reco/";
    ...
    },{id: "post-llm-interview-fundamentals-and-implementation",
      ...
      handler: () => {
          ...
          window.location.href = "/blog/2025/genai-memory/";
        
      },
    },{id: "post-genai-model-context-protocol-mcp-from-fundamentals-to-real-world-applications",
      ...
      handler: () => {
          ...
          window.location.href = "/blog/2025/genai-mcp/";
      ...
      handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%72%68%33%38%38%34@%6E%79%75.%65%64%75", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
