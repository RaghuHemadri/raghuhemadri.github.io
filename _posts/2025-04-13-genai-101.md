...
Now, we shift gears to something that determines _how well_ they act over time: **memory**.
...
Can you guess what _level_ of agents they are? Based on what we covered back in part 2, here’s a rough guess (since none of these are open source, we can’t say for sure):
