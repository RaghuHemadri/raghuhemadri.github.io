...
- [1. Foundations of Machine Learning](#1-foundations-of-machine-learning)
  - [1.1 Types of Learning](#11-types-of-learning)
- [1.2 Problem Types](#12-problem-types)
  - [1.2.1 Classification](#121-classification)
  - [1.2.2 Regression](#122-regression)
  - [1.2.3 Ranking](#123-ranking)
  - [1.2.4 Clustering](#124-clustering)
  - [1.2.5 Reinforcement Learning as a Problem Type](#125-reinforcement-learning-as-a-problem-type)
- [1.3 Bayes Rule, Conditional Independence, Graphical Model Basics](#13-bayes-rule-conditional-independence-graphical-model-basics)
  - [1.3.1 Bayes Rule](#131-bayes-rule)
  - [1.3.2 Conditional Independence](#132-conditional-independence)
  - [1.3.3 Graphical Model Basics (DAGs and Factorization)](#133-graphical-model-basics-dags-and-factorization)
- [1.4 Curse of Dimensionality](#14-curse-of-dimensionality)
  - [1.4.1 Volume and sparsity](#141-volume-and-sparsity)
  - [1.4.2 Distances concentrate](#142-distances-concentrate)
- [1.5 No Free Lunch Theorem (NFL)](#15-no-free-lunch-theorem-nfl)
- [1.6 Bias–Variance Trade-off](#16-biasvariance-trade-off)
- [1.7 Overfitting vs Underfitting](#17-overfitting-vs-underfitting)
  - [1.7.1 Underfitting](#171-underfitting)
  - [1.7.2 Overfitting](#172-overfitting)
- [2. Classical ML Algorithms](#2-classical-ml-algorithms)
  - [2.1 Linear Models](#21-linear-models)
  - [2.1.1 Linear Regression (OLS)](#211-linear-regression-ols)
  - [2.1.2 Ridge, Lasso, Elastic-Net](#212-ridge-lasso-elastic-net)
  - [2.1.3 Logistic Regression (Binary Classification)](#213-logistic-regression-binary-classification)
  - [2.1.4 Multinomial Logistic Regression (Softmax)](#214-multinomial-logistic-regression-softmax)
  - [2.1.5 Regularization in Linear and Logistic Models: When L1 vs L2?](#215-regularization-in-linear-and-logistic-models-when-l1-vs-l2)
- [2.2 Tree-Based Models](#22-tree-based-models)
  - [2.2.1 Decision Trees (CART)](#221-decision-trees-cart)
  - [2.2.2 Random Forests (Bagging)](#222-random-forests-bagging)
  - [2.2.3 Gradient Boosting (GBM Concepts)](#223-gradient-boosting-gbm-concepts)
  - [2.2.4 XGBoost, LightGBM, CatBoost Fundamentals](#224-xgboost-lightgbm-catboost-fundamentals)
- [2.3 Support Vector Machines (SVMs)](#23-support-vector-machines-svms)
  - [2.3.1 Hard-Margin SVM (Linearly Separable Case)](#231-hard-margin-svm-linearly-separable-case)
  - [2.3.2 Soft-Margin SVM (Non-Separable Case)](#232-soft-margin-svm-non-separable-case)
  - [2.3.3 Dual Formulation and Kernel Trick](#233-dual-formulation-and-kernel-trick)
  - [2.3.4 Common Kernels and Geometric Intuition](#234-common-kernels-and-geometric-intuition)
- [2.4 Nearest-Neighbor Methods](#24-nearest-neighbor-methods)
  - [2.4.1 k-Nearest Neighbors (k-NN)](#241-k-nearest-neighbors-k-nn)
  - [2.4.2 Distance Metrics and Their Effects](#242-distance-metrics-and-their-effects)
- [2.5 Clustering](#25-clustering)
  - [2.5.1 k-Means Clustering (Lloyd’s Algorithm)](#251-k-means-clustering-lloyds-algorithm)
  - [2.5.2 Gaussian Mixture Models (GMMs) and EM](#252-gaussian-mixture-models-gmms-and-em)
  - [2.5.3 DBSCAN and Hierarchical Clustering (Intuition)](#253-dbscan-and-hierarchical-clustering-intuition)
- [2.6 Probabilistic Models (Naive Bayes, HMMs, CRFs – High Level)](#26-probabilistic-models-naive-bayes-hmms-crfs--high-level)
  - [2.6.1 Naive Bayes](#261-naive-bayes)
  - [2.6.2 Hidden Markov Models (HMMs) – Basics](#262-hidden-markov-models-hmms--basics)
  - [2.6.3 CRFs (Very Light)](#263-crfs-very-light)
- [2.7 Dimensionality Reduction](#27-dimensionality-reduction)
  - [2.7.1 PCA (Principal Component Analysis)](#271-pca-principal-component-analysis)
  - [2.7.2 Kernel PCA (High-Level)](#272-kernel-pca-high-level)
  - [2.7.3 t-SNE and UMAP (Intuition)](#273-t-sne-and-umap-intuition)
- [3. Model Evaluation \& Metrics](#3-model-evaluation--metrics)
  - [3.1 Classification Metrics](#31-classification-metrics)
  - [3.2 Regression Metrics](#32-regression-metrics)
  - [3.3 Ranking / Search Metrics](#33-ranking--search-metrics)
  - [3.4 Probabilistic Predictions and Proper Scoring Rules](#34-probabilistic-predictions-and-proper-scoring-rules)
  - [3.5 Cross-Validation and Data Leakage](#35-cross-validation-and-data-leakage)
- [4. Optimization \& Training Dynamics](#4-optimization--training-dynamics)
  - [4.1 Gradient Descent, SGD, and Momentum](#41-gradient-descent-sgd-and-momentum)
  - [4.2 Newton’s Method and Quasi-Newton (BFGS, L-BFGS)](#42-newtons-method-and-quasi-newton-bfgs-l-bfgs)
  - [4.3 Coordinate Descent (Important for Lasso)](#43-coordinate-descent-important-for-lasso)
  - [4.4 Convex vs Non-Convex Optimization](#44-convex-vs-non-convex-optimization)
  - [4.5 Loss Landscape Intuition (Sharp vs Flat Minima)](#45-loss-landscape-intuition-sharp-vs-flat-minima)
  - [4.6 Hyperparameter Tuning: Grid, Random, Bayesian](#46-hyperparameter-tuning-grid-random-bayesian)
- [5. Feature Engineering \& Data Handling](#5-feature-engineering--data-handling)
  - [5.1 Normalization vs Standardization](#51-normalization-vs-standardization)
  ...
  - [5.4 Outliers and Robustness](#54-outliers-and-robustness)
  - [5.5 Feature Selection](#55-feature-selection)
  - [5.6 Interaction and Polynomial Features](#56-interaction-and-polynomial-features)
  - [5.7 Time-Series Feature Engineering](#57-time-series-feature-engineering)
- [6. Probability \& Statistics for ML](#6-probability--statistics-for-ml)
  - [6.1 Random Variables, Expectation, Variance](#61-random-variables-expectation-variance)
  - [6.2 Common Distributions (ML-Relevant)](#62-common-distributions-ml-relevant)
  - [6.3 Law of Large Numbers (LLN) and Central Limit Theorem (CLT)](#63-law-of-large-numbers-lln-and-central-limit-theorem-clt)
  - [6.4 Maximum Likelihood Estimation (MLE)](#64-maximum-likelihood-estimation-mle)
  - [6.5 Maximum A Posteriori (MAP) and Bayesian Inference](#65-maximum-a-posteriori-map-and-bayesian-inference)
  - [6.6 Conjugate Priors (High-Level)](#66-conjugate-priors-high-level)
  - [6.7 Sampling Methods: Rejection Sampling and Gibbs Sampling](#67-sampling-methods-rejection-sampling-and-gibbs-sampling)
  - [6.8 A/B Testing and Hypothesis Testing](#68-ab-testing-and-hypothesis-testing)
- [7. ML Theory Essentials](#7-ml-theory-essentials)
  - [7.1 Capacity, VC Dimension, and Rademacher Complexity (High-Level)](#71-capacity-vc-dimension-and-rademacher-complexity-high-level)
  - [7.2 Regularization as Complexity Control](#72-regularization-as-complexity-control)
  - [7.3 Generalization Bounds (Intuition, Not Formulas)](#73-generalization-bounds-intuition-not-formulas)
  - [7.4 Kernel Methods Fundamentals](#74-kernel-methods-fundamentals)
  - [7.5 EM Algorithm (Expectation-Maximization)](#75-em-algorithm-expectation-maximization)
  - [7.6 Information Theory Basics (Entropy, KL, Mutual Information)](#76-information-theory-basics-entropy-kl-mutual-information)
- [8. Model Explainability \& Interpretability](#8-model-explainability--interpretability)
  - [8.1 Global vs Local Interpretability](#81-global-vs-local-interpretability)
  - [8.2 Feature Importance](#82-feature-importance)
  - [8.3 Partial Dependence Plots (PDPs)](#83-partial-dependence-plots-pdps)
  - [8.4 LIME and SHAP](#84-lime-and-shap)
  - [8.5 Counterfactual Explanations](#85-counterfactual-explanations)
  - [8.6 Fairness Metrics (Brief)](#86-fairness-metrics-brief)
- [9. ML Systems \& Practical Engineering (Non-DL Focus)](#9-ml-systems--practical-engineering-non-dl-focus)
  - [9.1 Data Pipelines: Batch vs Streaming, Versioning, Feature Stores](#91-data-pipelines-batch-vs-streaming-versioning-feature-stores)
  - [9.2 Scaling Classical ML](#92-scaling-classical-ml)
  - [9.3 Serving: Latency, Serialization, Testing, Monitoring](#93-serving-latency-serialization-testing-monitoring)
  - [9.4 Search, Recsys, Ads (Non-DL Components)](#94-search-recsys-ads-non-dl-components)
- [10. Applied ML Domains (Breadth Topics)](#10-applied-ml-domains-breadth-topics)
  - [10.1 Search and Ranking](#101-search-and-ranking)
  - [10.2 Recommender Systems](#102-recommender-systems)
  - [10.3 Time-Series Forecasting](#103-time-series-forecasting)
  - [10.4 Causal Inference](#104-causal-inference)
  - [10.5 Anomaly Detection](#105-anomaly-detection)
  - [10.6 Optimization / Operations Research](#106-optimization--operations-research)
